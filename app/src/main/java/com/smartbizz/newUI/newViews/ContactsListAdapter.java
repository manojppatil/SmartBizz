...
public class ContactsListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.contact_layout = convertView.findViewById(R.id.contact_layout);
...
//        viewHolder.chkContact.setText(this.filteredContactsList.contactArrayList.get(position).toString());
        ...
        viewHolder.contact_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Contact contact = filteredContactsList.getContact(view.getId());

                if (contact != null && !alreadySelected(contact)) {
                    selectedContactsList.addContact(contact);
